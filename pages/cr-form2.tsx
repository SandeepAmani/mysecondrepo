...
const CRForm2: React.FC = () => {
    ...
    const defaultStyle = "w-full border p-2 rounded";
    ...
    return (
        <>
            <Accordion activeIndex={0} multiple className="w-full"  >
                <AccordionTab header="Section I: Change Request Details" className="w-full">
                    <div className="grid">
